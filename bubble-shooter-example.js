// ------------------------------------------------------------------------
// Bubble Shooter Game With HTML5 And JavaScript
//
// A bubble shooter game with HTML5 and JavaScript. In a bubble shooter game,
// the player shoots colored bubbles into a level that consists of other colored bubbles.
// When the bubble of the player collides with the bubbles in the level and a cluster of
// three or more bubbles with the same color is formed, the cluster is removed
// and the player is rewarded points. After removing clusters, some bubbles might
// be floating in the air. These clusters will be removed as well. Finally, the player is given
// the next bubble and can shoot again. If any of the bubbles reaches the bottom of the level,
// the player has lost the game. The game uses a variation on the Match-3 mechanic,
// the clustering of colored tiles.
// ------------------------------------------------------------------------
...
window.onload = function() {
    ...
    function drawFrame() {
        ...
        context.fillText("Bubble Shooter - COMPUTING STUDENT SOCIETY", 10, 37);
